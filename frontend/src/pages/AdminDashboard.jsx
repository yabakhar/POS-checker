...
export default function AdminDashboard() {
  ...
  const openReset = (client) => { setSelectedClient(client); setNewPassword(''); setError(''); setModal('reset'); };
  ...
  const handleRegenKey = async (client) => {
            ...
            {modal === 'create' && (
              <>
                ...
                <form onSubmit={handleCreate}>
                  ...
                  <input style={inpStyle('cp')} type="password" value={form.password} onChange={(e) => setForm({ ...form, password: e.target.value })}
                  ...
                  <div style={{ display: 'flex', gap: 10, marginTop: 8 }}>
                    ...
                    <button type="submit" disabled={submitting} style={{
                      ...
                      opacity: submitting ? 0.7 : 1, transition: 'background 150ms',
                    }}
            ...
            {modal === 'reset' && (
              <>
                ...
                <form onSubmit={handleReset}>
                  ...
                  <input style={inpStyle('np')} type="password" value={newPassword}
