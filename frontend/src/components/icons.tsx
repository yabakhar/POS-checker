...
export const DatabaseIcon = () => (
  <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
    <path d="M20.25 6.375c0 1.243-3.694 2.25-8.25 2.25s-8.25-1.007-8.25-2.25M20.25 6.375c0-1.243-3.694-2.25-8.25-2.25s-8.25 1.007-8.25 2.25M20.25 6.375v11.25C20.25 18.867 16.556 19.875 12 19.875s-8.25-1.008-8.25-2.25V6.375m16.5 0v3.75m-16.5-3.75v3.75m16.5 0v3.75C20.25 15.117 16.556 16.125 12 16.125s-8.25-1.008-8.25-2.25v-3.75m16.5 0c0 1.242-3.694 2.25-8.25 2.25s-8.25-1.008-8.25-2.25"/>
  </svg>
);
export const ChevronExpandIcon = ({ open }: { open: boolean }) => (
